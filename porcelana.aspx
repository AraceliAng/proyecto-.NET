<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="porcelana.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <tr>
     <td>
            ...
            string strSQL = "";
            strSQL = strSQL + " Select * from PRODUCTO where prod_categoria= 'Porcelana' ";
        ...
        <tr>
            <td>
    <asp:Button ID="Button10" runat="server" OnClick="Button10_Click" Text="Cerrar Sesión" />
            </td>
        </tr>
</table>    
</asp:Content>
