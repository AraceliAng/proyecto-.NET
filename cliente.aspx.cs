...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (obj.sesionc(TextBox9.Text, TextBox10.Text) == true)
        {
            ...
            Response.Write("<Script languaje='javascript'>document.location.href='porcelana.aspx';</script>");
        }
        else
        {
            Response.Write("<Script languaje='javasccript'>alert ('No eres cliente registrado');</script>");
        }
    }
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Write("<script language='javascript'>alert('El registro se guardó con exito');</script>");
                Response.Write("<script language='javascript'>document.location.href='cliente.aspx';</script>");
            }
            else
            {
                Response.Write("<Script languaje='javasccript'>alert ('Verifique que los datos sean correctos');</script>");
            }
        }
        catch
        {
            Response.Write("<Script languaje='javasccript'>alert ('Verifique los datos a ingresar');</script>");
        }
    }
