...
public partial class Default2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Response.Write("<script language='javascript'>alert('Usted no es un cliente registrado.');</script>");
            Response.Write("<script language='javascript'>document.location.href='liente.aspx';</script>");
        }
    }
