<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="mochila.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <tr>
     <td>
            ...
            string strSQL = "";
            strSQL = strSQL + " Select * from PRODUCTO where prod_categoria= 'Bolsos y mochilas' ";
        ...
        <tr>
            <td>
     <asp:Button ID="Button8" runat="server" OnClick="Button8_Click" Text="Cerrar Sesión" />
            </td>
        </tr>
</table>
</asp:Content>
