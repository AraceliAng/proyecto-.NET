<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="joyeria.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <tr>
     <td>
            ...
            string strSQL = "";
            strSQL = strSQL + " Select * from PRODUCTO where prod_categoria= 'Joyeria' ";
        ...
        <tr>
            <td>
    <asp:Button ID="Button11" runat="server" OnClick="Button11_Click" Text="Cerrar Sesión" />
            </td>
        </tr>
</table>
    </asp:Content>
